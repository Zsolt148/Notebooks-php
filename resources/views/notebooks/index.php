...
?>
    ...
    <div class="px-10 mx-auto max-w-7xl">
        <h1 class="text-2xl font-semibold text-gray-700 mb-8">Notebooks</h1>
            ...
            <table>
                ...
                <?php foreach($notebooks as $n) { ?>
                    <tr class="tr-class">
                        ...
                        <td class="td-class">
                            <a class="td-content" href="<?php echo route($routes->get('notebooks.show'), $n['id']); ?>">
                                View
                            </a>
                        </td>
                        <td class="td-class">
                            <a class="td-content" href="<?php echo route($routes->get('notebooks.edit'), $n['id']); ?>">
                                Edit
                            </a>
                        </td>
                        <td class="td-class">
                            <a class="td-content" href="<?php echo route($routes->get('notebooks.delete'), $n['id']); ?>">
                                Delete
                            </a>
                        </td>
                    </tr>
